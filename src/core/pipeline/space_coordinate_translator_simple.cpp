...
SpaceCoordinateTranslatorSimple::getPixelBuffer2dSpace() const
{
    return pixel_buffer2d_space_;
}

const ra_types::Space1i&
SpaceCoordinateTranslatorSimple::getDotBuffer1dSpace() const
{
    return dot_buffer1d_space_;
}

const ra_types::Space2i& SpaceCoordinateTranslatorSimple::getCanvas2dSpace()
    const
{
    return canvas2d_space_;
}

const ra_types::Space2i& SpaceCoordinateTranslatorSimple::getClippingWindow2dSpace()
    const
{
    return clipwin2d_space_;
}

void SpaceCoordinateTranslatorSimple::setClippingWindow2dSpace(
    const ra_types::Space2i& value)
{
    clipwin2d_space_ = value;
}

void SpaceCoordinateTranslatorSimple::setClippingWindowsOffset(
    ra_types::displacement2i newOffset)
{
    clipwin2d_space_.viewZeroPointOffset = newOffset;
}

void SpaceCoordinateTranslatorSimple::modClippingWindowSize(
